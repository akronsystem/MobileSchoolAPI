        ...
        public object GetAttendanceByUser(ParamDateWiseAttendance obj)
        {
            try
            {
                ...
                if (usertype[0].UserType == "STUDENT")
                {
                    ...
                    {
                        return  new AttendanceResult() { IsSuccess = false, UserWiseAttendanceList = "Status : Attendance Is Not Marked By Class Teacher For This Date"  };
                    }
                    else
                    { 
                ...
                else
                {
...

                    {
                        ...
                        {
                            return new AttendanceResult() { IsSuccess = false, UserWiseAttendanceList ="Status : Attendance Not Completed"  };
